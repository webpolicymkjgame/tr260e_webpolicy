          ...
          <div className="container header-container">
            <div className="header-left">
              <div className="logo-wrapper">
                <img src={logoImg} alt="NEXSCIENT GH" className="logo-img" />
                <span className="studio-name">NEXSCIENT GH</span>
              </div>
            </div>
      ...
      <section id="about" className="section about">
        <div className="container about-row">
          <div className="about-text-container">
            <h2 className="highlight-title">NEXSCIENT GH – Welcome Aboard</h2>
            <p className="about-text">NEXSCIENT GH is a forward-thinking mobile app studio committed to crafting innovative, dependable, and easy-to-use applications. Our mission is to blend creativity with functionality, delivering solutions that span across casual gaming, productivity, lifestyle, and education. Each app we develop is carefully designed with user experience in mind — offering intuitive navigation, thoughtful details, and practical value — to make everyday life simpler, smarter, and more enjoyable for users around the globe.
            </p>
          </div>
      ...
      <section id="contact" className="section contact">
        <div className="container text-center">
          ...
          <p>
            ...
            <a href="mailto:PatrickDonte06pcoas@gmail.com">PatrickDonte06pcoas@gmail.com</a><br />
            <span style={{ display: 'inline-block', marginTop: '10px' }}>
              🏠 Flat 3.12 Pulse Apartments
               52 Lymington Road
               London - NW6 1HQ
               United Kingdom (GB)
            </span>
    ...
    <Router>
      <div className="App">
        ...
        <footer className="footer">
          <div className="container text-center">
            <p>&copy; {new Date().getFullYear()} NEXSCIENT GH. All rights reserved.</p>
          </div>
        </footer>
      </div>
    </Router>
